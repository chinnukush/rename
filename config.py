...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "6890721669:AAG4thTeXIbW9vnGq2h14Kcuoa_R8EmOVns") 
   
    # database config
    DB_NAME = os.environ.get("DB_NAME","okenrename")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://Web:Web@cluster0.blbma.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "https://envs.sh/HwT.jpg")
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '5911514776 7253187871').split()]
...
ᴜꜱɪɴɢ ᴛʜɪꜱ ʙᴏᴛ ʏᴏᴜ ᴄᴀɴ ʀᴇɴᴀᴍᴇ ᴀɴᴅ ᴄʜᴀɴɢᴇ ᴛʜᴜᴍʙɴᴀɪʟ ɪғ ʏᴏᴜʀ ғɪʟᴇꜱ. ᴀɴᴅ ʏᴏᴜ ᴄᴀɴ ᴀʟꜱᴏ ᴄᴏɴᴠᴇʀᴛ ᴠɪᴅᴇᴏ ᴛᴏ ғɪʟᴇ ᴀɴᴅ ғɪʟᴇ ᴛᴏ ᴠɪᴅᴇᴏ.

ᴛʜɪꜱ ʙᴏᴛ ᴀʟꜱᴏ ꜱᴜᴘᴘᴏʀᴛꜱ ᴄᴜꜱᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ, ᴄᴜꜱᴛᴏᴍ ᴄᴀᴘᴛɪᴏɴ, ᴄᴜꜱᴛᴏᴍ ᴘʀᴇғɪx ᴀɴᴅ ꜱᴜғғɪx,</b>

<blockquote><b>ɴᴏᴛɪᴄᴇ 📢 :</b> <u>ʀᴇɴᴀᴍɪɴɢ ᴏғ ᴀᴅᴜʟᴛ ᴄᴏɴᴛᴇɴᴛ ᴀʀᴇ ꜱᴛʀɪᴄᴛʟʏ ᴘʀᴏʜɪʙɪᴛᴇᴅ 🚫. ɪғ ʏᴏᴜ ᴡɪʟʟ ᴅᴏ ʏᴏᴜ ᴡɪʟʟ ɢᴇᴛ ᴅɪʀᴇᴄᴛ ʙᴀɴ ғʀᴏᴍ ᴛʜᴇ ᴏᴡɴᴇʀ.</u>"</blockquote>"""


    ABOUT_TXT = """
<b>❍ ᴍʏ ɴᴀᴍᴇ : <a href='https://telegram.me/HK_Renamex_Bot'>ʀᴇɴᴀᴍᴇ ʙᴏᴛ 𝘃³</a>
❍ ᴄʜɪʟʟɪɴɢ ᴏɴ : ʜᴇʀᴏᴋᴜ
❍ ᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
❍ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 𝟹
❍ ᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href='https://telegram.me/Harikushal'>ʜᴀʀɪ ᴋᴜꜱʜᴀʟ</a>
...
💖 𝐔𝐏𝐈 𝐈𝐃 : <code>harikushal234@okicici</code>

💗 𝐐𝐑 𝐂𝐨𝐝𝐞 : <b><a href='https://envs.sh/Agj.jpg'>𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾</a></b>
"""
...
💬 For Help Contact @TG_BOTS_UPDATE
"""
